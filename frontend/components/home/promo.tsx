...
export const Promo = () => {
  return (
    <div className="px-4">
      <div className="border border-orange-300 rounded-lg md:rounded-xl relative max-w-screen-xl mx-auto flex flex-col md:flex-row items-center gap-4 backdrop-blur my-20 shadow-lg md:shadow-xl shadow-orange-300/20">
